...
int main()
{
	...
	cout<<endl<<"  -o miscare presupune introducerea a 3 date: ";
	cout<<endl<<"	doua coordonate (linie si coloana) si o 'actiune'.";
	cout<<endl<<"     -actiuni posibile: ";
	cout<<endl<<"		 - s (descoperirea unei casute/click stanga), ";
	cout<<endl<<"		 - f (stegulet/click dreapta), ";
	cout<<endl<<"		 - d (descoperirea casutelor vecine/click stanga ";
	cout<<endl<<"	           si click dreapta simultan).";
	cout<<endl<<endl<<"Pentru inceperea jocului introduceti ";
	cout<<endl<<"	litera corespunzatoare nivelului dorit:";
	cout<<endl<<" b - beginner";
	cout<<endl<<" i - intermediate";
	cout<<endl<<" e - expert";
	cout<<endl<<endl<<"	SUCCES!!!"<<endl;
...
int desfasurareJoc(int x, int y, int numarBombe)
{
	...
	do
	{
		do
		{
			...
			cin>>mutare.primaCoordonata;
			cin>>mutare.aDouaCoordonata;
			cin>>mutare.actiune;
